package Laboratorio05 is
   ...
   --Entrada Est�ndar: Secuencia de positivos terminada en 0
   ...
   --      omirp_n contiene el �ltimo omirp de la secuencia
   ...
   function P_Aritmetica (A1,D,N: in Natural) return Natural;
   --Post: Resultado = Elemento N-simo de la progresion

   function P_Geometrica (B1,R,N: in Natural) return Natural;
   --Post: Resultado = Elemento N-simo de la progresion

   procedure Multiplicar_Karatsuba(N1,N2: in String; R: out String);
   --Post: R = N1 * N2

   procedure Secuencia_Texto_Puntuado(Puntos,Caracteres: out Natural);
     --Pre: EE: una l�nea de texto terminada en EOL
     --Post: Grupos = numero de grupos que hay en la l�nea de texto
     --      Puntos = puntos que obtienen entre TODOS los grupos
end Laboratorio05;

...
PROCEDURE laboratorio12_pruebas IS
   ...
   LP1_Res: T_Lista_Puntos := null;
   LP2_Res: T_Lista_Puntos := null;
   LP4_Res: T_Lista_Puntos := null;
   LP5_Res: T_Lista_Puntos := null;
   ...
   END recorrer;
    ...
    procedure recorrer_puntos(L: T_Lista_Puntos) IS
   BEGIN
      if L /= null then
         New_Line;
         Put(" ("); put(L.info.X'img); Put(",");
         put(L.Info.Y'img); Put(") ");
         recorrer_puntos(L.sig);
      end if;
   END recorrer_puntos;
...
BEGIN
   ...
   Put_Line("Caso 5:");
   Put_Line("Interseccion(1 3 5 7)y(7):(7 7)y(1 3 5 7)");
   L1:= --(1 3 5 7)
      new T_Nodo_Enteros'(1,
      new T_Nodo_Enteros'(3,
      new T_Nodo_Enteros'(5,
   ...
   Put("Lista original: "); recorrer_puntos(Lp_Copia); New_Line;
   simplificar1(LP_copia, cuantos);
   Put("Simplificada: "); recorrer_puntos(Lp_Copia); Put("--"); Put(cuantos'IMG); New_Line;

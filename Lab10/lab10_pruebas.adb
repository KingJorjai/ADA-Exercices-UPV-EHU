with Laboratorio10; use Laboratorio10;
with lab10_escenarios; use Lab10_escenarios;
with  Ada.Text_IO, Ada.Integer_Text_IO, Ada.Float_Text_IO;
use  Ada.Text_IO, Ada.Integer_Text_IO, Ada.Float_Text_IO;
procedure Lab10_Pruebas is
...
begin
   ...
   Put_Line("Si L= [] y N= 9 debería quedar [9]");
   L.Dato:= (4, 5, 3, 6, others => Integer'First);
   L.cont:= 0;
   Num2:= 9;
   Insertar_En_Medio(L, Num2);
   ...
   Put_Line("Si L= [1, 2, 2, 1] debería quedar [1, 2, 2, 1]");
   L.Dato:= (1, 2, 2, 1, others => Integer'First);
   L.cont:= 4;
   Borrar_Intermedio(L);
   J:= l.Dato'First;
   while J < (L.cont+l.Dato'First) loop
  ...
  --------------------
   ...
   --     new_line;
   --  end loop;
   --  Put(Boolean'Image(R=R1)); New_Line;
   ...
   --     new_line;
   --  end loop;
   --  Put(Boolean'Image(R=R2)); New_Line;
   ...
   --     new_line;
   --  end loop;
   --  Put(Boolean'Image(R=R3)); New_Line;
   ...
   --caso 2: Datos en Lab09_Escenarios. Resultado debe ser Con_ele_E1 y Con_gas_E1
   ...
   New_Line;
   Put(Boolean'Image(Consumo_electrico=Con_Ele_E1));
   Put(Boolean'Image(Consumo_gas=Cmm_Gas_E1));
   New_Line(2);


   --caso 3: Datos en Lab09_Escenarios. Resultado debe ser Con_ele_E1 y Con_gas_E1
   ...
   New_Line;
   Put(Boolean'Image(Consumo_electrico=Con_Ele_E2));
   Put(Boolean'Image(Consumo_gas=Cmm_Gas_E2));
   New_Line(2);
   ...
   -- Mas datos disponibles en Lab09_escenarios
   ...
   mostrar_carreteras(LC, LC.Ctras'First, LC.Ctras'First+L.Cont-1);

package Laboratorio03 is
    ...
    -- Pre: Base, Altura > 0
    --Post: Resultado es el �rea de un tri�ngulo de base Base y altura Altura

    function Area_Triangulo2 (A,B,C: in Float) return Float;
    -- Pre: A,B,C > 0 y los lados corresponden a un tri�ngulo
    --Post: Resultado es el �rea del tri�ngulo con las medidas descritas 
    ...
    --      Angulo_Contiguo es el �ngulo (en grados) contiguo al lado A
    ...
    -- Pre: (X1,Y1),(x2,Y2) y (X3,Y3) son las coordenadas de los v�rtices del triangulo
    --Post: Resultado es el �rea del tri�ngulo con esos vertices
    ...
    --pre: D,M,A>0.  D<=31, M<=12 (y reglas de concordancia del n�mero de d�as con mes)
    ...
    --      las cuatro cifras menos significativas representan un a�o,
    --      las dos siguientes corresponden a un mes (valores entre 1 y 12)
    --      el resto (1 o 2) son un valor entre 1..31 (en conjuncion con el valor de M el limite est� en 28,29,30,31)
    --post: D es el valor de las primeras cifras
    --      M es el valor de las dos siguientes
    --      A es el valor del a�o

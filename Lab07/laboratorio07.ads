package Laboratorio07 is
   ...
   procedure Canoga(Puntos: out Natural);
   -- Entrada estándar: Números correspondientes a las opciones elegidas
   -- Post: Puntos correspondientes a un turno de Canoga según las opciones elegidas
   -- Salida estándar: Una serie de tiradas de dados y lista de combinaciones (posibles) con esa tirada
end Laboratorio07;
